...
<body class="offline-doc">
    ...
    <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
            <div class="navbar-wrapper">
                <img src="../assets/img/icon/MOBALERT_LOGO.png" style="width: 30px" alt="">
                <a class="navbar-brand" href="javascript:;">Welcome to MOBAlert</a>
            </div>
            ...
            <div id="card" class="col-lg-6 col-md-12 ml-auto mr-auto">
                <div class="card text-center">
                    <div class="card-header card-header-tabs" style="background-color: #de0c3b;">
                        ...
                        <div class="nav-tabs-navigation">
                            <div class="nav-tabs-wrapper">
                                <h4 class="font-weight-bold">MOBAlert</h4>
                    ...
                    <div class="card-body text-center">
                        <img src="../assets/img/icon/MOBALERT_LOGO.png" style="width: 90px; margin-top: -15px" alt="">
                                    ...
                                    <form v-on:submit.prevent="signinEnter">
                                        ...
                                        <div class="" style="margin-top: -20px;">
                                            <v-btn style="text-transform: none; font-size: 14px; color: #de0c3b; height: 55px;" class="w-100" type="submit" rounded :loading="loading3" :disabled="loading3" color="#eee" class="ma-2 white--text" @click="loader = 'loading3'" large>
                                                <img src="../assets/img/icon/MOBALERT_LOGO.png" style="width: 23px" alt="">
                                                &emsp;
                                                Sign in with MOBAlert
                                            </v-btn>
                                        </div>
                                        <div class="text-center" style="margin: 8px">or connect with</div>
                                        <v-btn class="mx-2" fab dark color="#034e99" onclick="FB.login()">
                                            <v-icon dark>mdi-facebook</v-icon>
                                        </v-btn>
                                        <v-btn class="mx-2 " fab dark color="#b5041b" data-onsuccess="onSignIn" data-width="35" data-layout="rounded">
                                            ...
                                            <div class="row">
                                                ...
                                                <template>
                                                    <v-col cols="4" sm="4">
                                                        ...
                                                        <v-text-field v-model="user.mname" label="Middle Initial" :rules="[rules.required]" clearable></v-text-field>
                                                    ...
                                                    <v-col cols="4" sm="4">
                                                        ...
                                                        <v-btn style="text-transform: none; font-size: 14px; color: #de0c3b; height: 55px;" class="w-100" rounded color="#eee" class="ma-2 white--text" large @click="signup_user()">
                                                            <div id="aha" style="width: 42px; margin-left: 2px; height: 42px; background-image: url('../assets/img/icon/MOBALERT_LOGO.png'); background-position: center; background-size: cover; border-radius: 50%"></div>
                                                            &emsp;
                                                            Sign up
                                                        </v-btn>
                                                    </v-col>
    ...
    <footer class="footer">
        <div class="container-fluid">
            ...
            <div class="copyright float-right" style="font-size: 12px">
                &copy;
                <script>
                    document.write(new Date().getFullYear())
                </script>
                <a href="https://www.creative-tim.com" target="_blank">MOBAlert</a>:&nbsp;A Multi-user Online Bayan Alert for inccidents and notification with Fire Safety Online Application
            </div>
        </div>
    </footer>
