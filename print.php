...
<body onload="window.print()" onfocus="window.close()" style="padding: 0; margin: 0; background-image: url(includes/forms/business_permit.png); background-attachment: fixed; background-size: cover;">
    ...
    <div style="text-align: center; width: 400px; position: fixed; top: 400px; left: 320px; width: 90px">
    ...
    <div style="text-align: center; width: 400px; position: fixed; top: 486px; left: 232px; width: 90px">
        <p style="font-family: tahoma; font-weight: bold; font-size: 13px"><?php echo $address; ?></p>
    </div>
    ...
    <div style="text-align: center; width: 400px; position: fixed; top: 725px; left: 416px; width: 400px">
        <p style="font-family: tahoma; font-weight: bold; font-size: 13px"><?php echo $inspectors; ?></p>
    </div>
